...
num_bottom_left_resample <- purrr::map_int(1:nRepeats,function(x) resample_distances(S) %>% get_number_in_bottom_left(.,a=2,b=2))
...
S_random_plot <- resample_distances(S)
...
return(sim_ecdf(num_bottom_left_data))
}
